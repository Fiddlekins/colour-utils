...
describe('parseHex', () => {
    it('should parse "#RGB" correctly', () => {
        const positiveTests: [string, RGB][] = [
            ['#000', { r: 0, g: 0, b: 0, a: 1 }],
        ...
        for (const input of negativeTests) {
            expect(parseHex.bind(null, input)).to.throw(Error, /invalid/i, `for input ${input}`);
        }
    });
...
describe('parseRgb', () => {
    it('should parse "rgb(R G B)" correctly', () => {
        ...
        for (const input of negativeTests) {
            expect(parseRgb.bind(null, input)).to.throw(Error, /invalid/i, `for input ${input}`);
        }
    });
    it('should parse "rgb(R, G, B)" correctly', () => {
        const positiveTests: [string, RGB][] = [
...
describe('parseHsl', () => {
    it('should parse "hsl(H S L)" correctly', () => {
        const positiveTests: [string, HSL][] = [
        ...
        for (const input of negativeTests) {
            expect(parseHsl.bind(null, input)).to.throw(Error, /invalid/i, `for input ${input}`);
        }
    });
    it('should parse "hsl(H, S, L)" correctly', () => {
        const positiveTests: [string, HSL][] = [
